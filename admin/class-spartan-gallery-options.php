 ...
 $fields[] = array(
     ...
     'fields' => array(
         ...
         array(
             ...
             'options'   => array(
                 'flex-grid' => plugins_url( '/img/FlexFreewallTable.png',  __FILE__ ),
                 'image-grid' => plugins_url( '/img/ImageFreewallGrid.png',  __FILE__ ),
                 'nested-grid' => plugins_url( 'img/NestedFreewallGrid.png',  __FILE__ ),
